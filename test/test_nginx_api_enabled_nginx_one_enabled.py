...
labels = {'expect-nginx-api': 'enabled', 'expect-nginx-one': 'enabled'}
...
def test_hosts(hosts: Dict[str, Host], nginx_api_enabled, nginx_one_enabled) -> None:
    ...
    for name, host in hosts.items():
        ...
        nginx_api_enabled(name, host)
        nginx_one_enabled(name, host)
